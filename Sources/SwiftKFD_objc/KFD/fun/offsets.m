...
#define SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(v) ([GET_SYSTEM_VERSION() compare:v options:NSNumericSearch] != NSOrderedAscending)
#define SYSTEM_VERSION_LESS_THAN(v)                 ([GET_SYSTEM_VERSION() compare:v options:NSNumericSearch] == NSOrderedAscending)
#define SYSTEM_VERSION_LESS_THAN_OR_EQUAL_TO(v)     ([GET_SYSTEM_VERSION() compare:v options:NSNumericSearch] != NSOrderedDescending)
